...
"
" apdl custom macros
syn   match   apdlMacro   display   "a3dlcp\>"               contained
...
syn   match   apdlMacro   display   "acv\>"                  contained
...
syn   match   apdlMacro   display   "alapic\>"               contained
...
syn   match   apdlMacro   display   "arcone\>"               contained
...
syn   match   apdlMacro   display   "cmadd\>"                contained
...
syn   match   apdlMacro   display   "compare\>"              contained
...
syn   match   apdlMacro   display   "cpcomb\>"               contained
...
syn   match   apdlMacro   display   "default4w\>"            contained
...
syn   match   apdlMacro   display   "erestore\>"             contained
...
syn   match   apdlMacro   display   "frzview\>"              contained
...
syn   match   apdlMacro   display   "go2pngv\>"              contained
...
syn   match   apdlMacro   display   "jvfd_conc\>"            contained
syn   match   apdlMacro   display   "kbackup\>"              contained
syn   match   apdlMacro   display   "kds\>"                  contained
...
syn   match   apdlMacro   display   "multipathplot\>"        contained
...
syn   match   apdlMacro   display   "nemar\>"                contained
...
syn   match   apdlMacro   display   "plain4w\>"              contained
...
syn   match   apdlMacro   display   "pthpic\>"               contained
...
syn   match   apdlMacro   display   "qkmc\>"                 contained
...
syn   match   apdlMacro   display   "testme\>"               contained
...
syn   match   apdlMacro   display   "view2wlr\>"             contained
syn   match   apdlMacro   display   "view4w\>"               contained
syn   match   apdlMacro   display   "view4wz\>"              contained
...
syn   match   apdlMacro   display   "wnpost\>"               contained
syn   match   apdlMacro   display   "wntitle\>"              contained
syn   match   apdlMacro   display   "wprest\>"               contained
